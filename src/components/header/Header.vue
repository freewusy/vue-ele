                ...
                .supports {
                    ...
                    .support-item {
                        ...
                        .icon {
                            ...
                            &.decrease {
                                @include bg-img("../../../resource/img/decrease_2");
                            }
                            &.discount {
                                @include bg-img("../../../resource/img/discount_2");
                            }
                            &.guarantee {
                                @include bg-img("../../../resource/img/guarantee_2");
                            }
                            &.invoice {
                                @include bg-img("../../../resource/img/invoice_2");
                            }
                            &.special {
                                @include bg-img("../../../resource/img/special_2");
                            }
                        }
